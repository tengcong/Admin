class Admin::BqPackagesController < Admin::MainController
  ...
  def create
    ...
    respond_to do |format|
      if @bq_package.save
        format.html { redirect_to [:admin, @bq_package], notice: 'Bq package was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @bq_package.update(bq_package_params)
        format.html { redirect_to [:admin, @bq_package], notice: 'Bq package was successfully updated.' }
  ...
  def destroy
    @bq_package.destroy
    respond_to do |format|
      format.html { redirect_to admin_bq_packages_path, notice: 'Bq package was successfully destroyed.', turbolinks: true }
